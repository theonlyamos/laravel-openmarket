            ...
            <div class="kt-grid">
                <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v4__wrapper">
                    ...
                    <form class="kt-form pt-0" style="width: 90%" id="kt_apps_product_add_product_form" novalidate="novalidate"
                        method="POST" action="{{route('store.product.new')}}" enctype="multipart/form-data">
                        @method('_POST')
                        @csrf
                                            ...
                                            <div class="kt-section__body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6 col-lg-4">
                                                        ...
                                                        <input type="number" class="form-control bg-light" name="quantity"
                                                                data-name="quantity" value="" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
