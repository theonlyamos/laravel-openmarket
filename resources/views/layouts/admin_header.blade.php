                ...
                <div class="col-lg-12 d-block">
                    <div class="row d-flex">
                        <div class="col-md pr-4 d-flex topper align-items-center">
                            ...
                            <span class="text">{{$site_info->phone_developer}}</span>
                        </div>
                        <div class="col-md pr-4 d-flex topper align-items-center">
                            <div class="icon mr-2 d-flex justify-content-center align-items-center"><span
                                    class="fa fa-paper-plane"></span></div>
                            <span class="text">{{Str::lower($site_info->email_info)}}</span>
                        </div>
                        <div class="col-md pr-4 d-flex topper align-items-center">
                            <div class="icon mr-2 d-flex justify-content-center align-items-center"><span
                ...
                <div class="col-md">
                    <div class="ftco-footer-widget mb-4">
                        ...
                        <div class="block-23 mb-3">
                            <ul>
                                <li><span class="fa fa-map-marker fa-fw"></span><span class="text">{{$site_info->address}}</span></li>
                                <li><span class="fa fa-plane"></span><span class="text">{{$site_info->box_office}}</span></li>
                                <li><a href="#"><span class="fa fa-phone fa-fw"></span><span class="text">{{$site_info->phone_developer}}</span></a></li>
                                <li><a href="#"><span class="fa fa-envelope fa-fw"></span><span
                                            class="text">{{Str::lower($site_info->email_support)}}</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
